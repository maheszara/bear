...
<section class="home">
   ...
   <div class="content">
      <h3>produk baru</h3>
      <p>Kue Terbaru Setiap Harinya, ayooo beli Kue Edisi Terbatas</p>
      <a href="about.php" class="btn">yuk belanja</a>
   </div>
...
<section class="products">
   ...
   <div class="box-container">
      ...
      <form action="checkout.php" method="POST" class="box">
         ...
         <input type="submit" value="add to checkout" name="add_to_checkout" class="btn">
      </form>
      <?php
         }
      }else{
   ...
   <div class="more-btn">
      <a href="shop.php" class="option-btn">selebihnya</a>
   </div>
